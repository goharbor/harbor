...
- Get official Golang image from docker hub:
  ...
  ```sh
     $ docker pull goharbor/golang:1.23.4
  ```

- Build, install and bring up Harbor without Notary:

  ```sh
     $ make install GOBUILDIMAGE=goharbor/golang:1.23.4 COMPILETAG=compile_golangimage
  ```

- Build, install and bring up Harbor with Notary:

  ```sh
     $ make install GOBUILDIMAGE=goharbor/golang:1.23.4 COMPILETAG=compile_golangimage NOTARYFLAG=true
  ```

- Build, install and bring up Harbor with Clair:

  ```sh
     $ make install GOBUILDIMAGE=goharbor/golang:1.23.4 COMPILETAG=compile_golangimage CLAIRFLAG=true
  ```
