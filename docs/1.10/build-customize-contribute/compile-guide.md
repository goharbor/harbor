...
Edit the file **make/harbor.yml** and make necessary configuration changes such as hostname, admin password and mail server. Refer to the[Installation and Configuration Guide](installation_guide.md#configuring-harbor) for more info.
