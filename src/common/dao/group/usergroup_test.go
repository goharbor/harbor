...
func TestAddUserGroup(t *testing.T) {
	...
	tests := []struct {
		...
		{"Insert an ldap user group", args{userGroup: models.UserGroup{GroupName: "sample_group", GroupType: 1, GroupProperty: "sample_ldap_dn_string"}}, 0, false},
		{"Insert an ldap user group second time", args{userGroup: models.UserGroup{GroupName: "sample_group", GroupType: 1, GroupProperty: "sample_ldap_dn_string"}}, 0, false},
		{"Insert other user group", args{userGroup: models.UserGroup{GroupName: "other_group", GroupType: 3, GroupProperty: "other information"}}, 0, false},
	}
...
func TestQueryUserGroup(t *testing.T) {
	...
	tests := []struct {
		...
		{"Query ldap group with group property", args{query: models.UserGroup{GroupType: 1, GroupProperty: "CN=harbor_users,OU=sample,OU=vmware,DC=harbor,DC=com"}}, 1, false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestGetUserGroup(t *testing.T) {
	userGroup := models.UserGroup{GroupName: "insert_group", GroupType: 1, GroupProperty: "ldap_dn_string"}
...
func TestUpdateUserGroup(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := UpdateUserGroup(tt.args.id, tt.args.groupName); (err != nil) != tt.wantErr {
