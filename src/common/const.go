...
const (
	...
	PostGreSQLReaderHOST             = "postgresql_reader_host"
	PostGreSQLReaderPort             = "postgresql_reader_port"
	PostGreSQLReaderUsername         = "postgresql_reader_username"
	PostGreSQLReaderPassword         = "postgresql_reader_password"
	PostGreSQLReaderDatabase         = "postgresql_reader_database"
	PostGreSQLReaderSSLMode          = "postgresql_reader_sslmode"
	PostGreSQLReaderMaxIdleConns     = "postgresql_reader_max_idle_conns"
	PostGreSQLReaderMaxOpenConns     = "postgresql_reader_max_open_conns"
	PostGreSQLReaderConnMaxLifetime  = "postgresql_reader_conn_max_lifetime"
	PostGreSQLReaderConnMaxIdleTime  = "postgresql_reader_conn_max_idle_time"
