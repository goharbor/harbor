...
var (
	...
	TestServerDefaultConfig = map[string]interface{}{
		ExtEndpoint:                "https://host01.com",
		AUTHMode:                   DBAuth,
		DatabaseType:               "postgresql",
		PostGreSQLHOST:             "127.0.0.1",
		PostGreSQLPort:             5432,
		PostGreSQLUsername:         "postgres",
		PostGreSQLPassword:         "root123",
		PostGreSQLDatabase:         "registry",
		SelfRegistration:           true,
		LDAPURL:                    "ldap://127.0.0.1",
		LDAPSearchDN:               "uid=searchuser,ou=people,dc=mydomain,dc=com",
		LDAPSearchPwd:              "password",
		...
		TokenServiceURL:            "http://token_service",
		RegistryURL:                "http://registry",
		EmailHost:                  "127.0.0.1",
		EmailPort:                  25,
		EmailUsername:              "user01",
		EmailPassword:              "password",
		EmailFrom:                  "from",
		EmailSSL:                   true,
		EmailInsecure:              false,
		EmailIdentity:              "",
		ProjectCreationRestriction: ProCrtRestrAdmOnly,
		MaxJobWorkers:              3,
		TokenExpiration:            30,
		CfgExpiration:              5,
		...
		ClairDBHost:                "postgresql",
		ClairDB:                    "postgres",
		ClairDBPort:                5432,
		ClairDBPassword:            "root123",
		UAAClientID:                "testid",
		UAAClientSecret:            "testsecret",
		UAAEndpoint:                "10.192.168.5",
		UAAVerifyCert:              false,
		CoreURL:                    "http://myui:8888/",
		JobServiceURL:              "http://myjob:8888/",
		ReadOnly:                   false,
		NotaryURL:                  "http://notary-server:4443",
	}
)
