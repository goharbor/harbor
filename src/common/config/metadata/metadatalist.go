...
var (
	...
	ConfigList = []Item{
		...
		{Name: common.LDAPNestedGroupSearch, Scope: UserScope, Group: LdapBasicGroup, EnvKey: "LDAP_NESTED_GROUP_SEARCH", DefaultValue: "false", ItemType: &BoolType{}, Editable: false},
