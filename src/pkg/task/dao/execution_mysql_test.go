...
type executionMysqlDAOTestSuite struct {
	suite.Suite
	ctx          context.Context
	executionDAO *executionMysqlDAO
	taskDao      *taskMysqlDAO
	executionID  int64
}

func (e *executionMysqlDAOTestSuite) SetupSuite() {
	dao.PrepareTestForDB()
	e.ctx = orm.Context()
	e.taskDao = &taskMysqlDAO{}
	e.executionDAO = &executionMysqlDAO{
		taskDAO: e.taskDao,
	}
}

func (e *executionMysqlDAOTestSuite) SetupTest() {
...
func (e *executionMysqlDAOTestSuite) TearDownTest() {
	err := e.executionDAO.Delete(e.ctx, e.executionID)
	e.Nil(err)
}

func (e *executionMysqlDAOTestSuite) TestCount() {
...
func (e *executionMysqlDAOTestSuite) TestList() {
...
func (e *executionMysqlDAOTestSuite) TestGet() {
	// not exist
...
func (e *executionMysqlDAOTestSuite) TestCreate() {
	// happy pass is covered by SetupTest
}

func (e *executionMysqlDAOTestSuite) TestUpdate() {
	// not exist
...
func (e *executionMysqlDAOTestSuite) TestDelete() {
	// not exist
...
func (e *executionMysqlDAOTestSuite) TestGetMetrics() {
...
func (e *executionMysqlDAOTestSuite) TestRefreshStatus() {
...
func TestExecutionMysqlDAOSuite(t *testing.T) {
	if !utils.IsDBMysql() {
		return
	}
	suite.Run(t, &executionMysqlDAOTestSuite{})
}

func Test_buildInClauseSqlForExtraAttrsForMysql(t *testing.T) {
	type args struct {
		keys []string
	}
	tests := []struct {
		...
		{"extra_attrs.id", args{[]string{"id"}}, "select id from execution where json_extract(extra_attrs, '$.id')=?"},
		{"extra_attrs.artifact.digest", args{[]string{"artifact", "digest"}}, "select id from execution where json_extract(extra_attrs, '$.artifact.digest')=?"},
		{"extra_attrs.a.b.c", args{[]string{"a", "b", "c"}}, "select id from execution where json_extract(extra_attrs, '$.a.b.c')=?"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := buildInClauseSQLForExtraAttrsForMysql(tt.args.keys); got != tt.want {
				t.Errorf("buildInClauseSQLForExtraAttrsForMysql() = %v, want %v", got, tt.want)
			}
		})
	}
}
