...
func newAdapter(registry *model.Registry) *adapter {
	...
	authorizer := NewAuthorizer(username, password, registry.Insecure)
...
*/
func (a adapter) listGarTagsByRef(repository, reference string) ([]string, string, error) {
...
func (a adapter) DeleteManifest(repository, reference string) error {
	tags, d, err := a.listGarTagsByRef(repository, reference)
	if err != nil {
		return err
	}
