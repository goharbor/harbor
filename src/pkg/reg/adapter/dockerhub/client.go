...
// the resulting token. Callers must hold c.mu before calling this method except
// from NewClient before any concurrent use.
func (c *Client) refreshToken() error {
	...
	// Tokens issued by Docker Hub login expire after a short interval; refresh 1 minute
