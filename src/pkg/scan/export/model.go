...
// Criteria encapsulates the filters to be provided when exporting the data for a scan.
...
func (c *Criteria) FromJSON(jsonData string) error {
	if len(jsonData) == 0 {
...
func (c *Criteria) ToJSON() (string, error) {
