...
import (
	...
	index2 "github.com/goharbor/harbor/src/pkg/reselector/selectors/index"
...
func NewBuilder(all []*reselector.Candidate) Builder {
	return &basicBuilder{
		allCandidates: all,
	}
}
...
type basicBuilder struct {
	allCandidates []*reselector.Candidate
}
