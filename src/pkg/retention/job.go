...
func saveRetainNum(ctx job.Context, retained []*reselector.Result, allCandidates []*reselector.Candidate) error {
	var delNum int
...
func logResults(logger logger.Interface, all []*reselector.Candidate, results []*reselector.Result) {
	...
	op := func(art *reselector.Candidate) string {
...
func arn(art *reselector.Candidate) string {
...
func getParamRepo(params job.Parameters) (*reselector.Repository, error) {
