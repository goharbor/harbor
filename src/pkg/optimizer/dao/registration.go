...
// GetTotalOfRegistrations returns the total count of optimizer registrations according to the query.
...
func SetDefaultRegistration(ctx context.Context, UUID string) error {
	...
	return orm.WithTransaction(f)(orm.SetTransactionOpNameToContext(ctx, "tx-optimizer-set-default-registration"))
}
