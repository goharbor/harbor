...
import (
	...
	"github.com/goharbor/harbor/src/server/handler/v2.1/restapi/operations/auditlog"
	operation "github.com/goharbor/harbor/src/server/handler/v2.1/restapi/operations/auditlog"
)
