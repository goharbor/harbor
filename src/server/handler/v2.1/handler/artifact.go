...
import (
	...
	"github.com/goharbor/harbor/src/server/handler/v2.1/handler/assembler"
	"github.com/goharbor/harbor/src/server/handler/v2.1/handler/model"
	"github.com/goharbor/harbor/src/server/handler/v2.1/models"
	operation "github.com/goharbor/harbor/src/server/handler/v2.1/restapi/operations/artifact"
