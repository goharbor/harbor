...
import (
	...
	"github.com/goharbor/harbor/src/server/handler/v2.0/restapi/operations/auditlog"
	operation "github.com/goharbor/harbor/src/server/handler/v2.0/restapi/operations/auditlog"
)
