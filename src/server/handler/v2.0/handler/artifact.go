...
import (
	...
	"github.com/goharbor/harbor/src/server/handler/v2.0/handler/assembler"
	"github.com/goharbor/harbor/src/server/handler/v2.0/handler/model"
	"github.com/goharbor/harbor/src/server/handler/v2.0/models"
	operation "github.com/goharbor/harbor/src/server/handler/v2.0/restapi/operations/artifact"
