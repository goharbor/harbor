...
import (
	...
	operation "github.com/goharbor/harbor/src/server/handler/v2.0/restapi/operations/repository"
)
...
func (r *repositoryAPI) assembleRepository(ctx context.Context, repository *cmodels.RepoRecord) *models.Repository {
	repo := &models.Repository{
		CreationTime: strfmt.DateTime(repository.CreationTime),
		Description:  repository.Description,
		ID:           repository.RepositoryID,
		Name:         repository.Name,
		ProjectID:    repository.ProjectID,
		PullCount:    repository.PullCount,
		UpdateTime:   strfmt.DateTime(repository.UpdateTime),
	}
