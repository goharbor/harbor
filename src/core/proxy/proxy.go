...
func Init(urls ...string) error {
	...
	handlers = handlerChain{head: readonlyHandler{next: PushRepoHandler{next: urlHandler{next: listReposHandler{next: contentTrustHandler{next: vulnerableHandler{next: Proxy}}}}}}}
	return nil
}
