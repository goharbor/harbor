...
func initRouters() {
	...
	if !config.WithAdmiral() {
		...
		beego.Router("/c/oauth2/authorize", &controllers.CommonController{}, "get:OauthAuthorize")
		beego.Router("/c/oauth2/callback", &controllers.CommonController{}, "get:OauthCallback")
