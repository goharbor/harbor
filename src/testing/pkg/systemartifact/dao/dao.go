...
// Create provides a mock function with given fields: ctx, artifactRecord
func (_m *DAO) Create(ctx context.Context, artifactRecord *model.SystemArtifact) (int64, error) {
	ret := _m.Called(ctx, artifactRecord)

	var r0 int64
	if rf, ok := ret.Get(0).(func(context.Context, *model.SystemArtifact) int64); ok {
		r0 = rf(ctx, artifactRecord)
	} else {
		r0 = ret.Get(0).(int64)
	}
