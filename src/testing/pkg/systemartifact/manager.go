...
func (_m *Manager) GetCleanupCriteria(vendor string, artifactType string) systemartifact.CleanupCriteria {
	ret := _m.Called(vendor, artifactType)

	var r0 systemartifact.CleanupCriteria
	if rf, ok := ret.Get(0).(func(string, string) systemartifact.CleanupCriteria); ok {
		r0 = rf(vendor, artifactType)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(systemartifact.CleanupCriteria)
		}
	}
...
func (_m *Manager) RegisterCleanupCriteria(vendor string, artifactType string, criteria systemartifact.CleanupCriteria) {
