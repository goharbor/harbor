...
func (_m *Client) ListReferrers(repository string, digest string, rawQuery string) (*v1.Index, map[string][]string, error) {
...
func (_m *Client) PullBlobRange(ctx context.Context, repository string, digest string, byteRange string, ifRange string) (*http.Response, error) {
