...
// BlobReaderAt provides a mock function with given fields: repo, dig, size, start
func (_m *RemoteInterface) BlobReaderAt(repo string, dig string, size int64, start int64) (io.ReadCloser, error) {
	ret := _m.Called(repo, dig, size, start)

	if len(ret) == 0 {
		panic("no return value specified for BlobReaderAt")
	}

	var r0 io.ReadCloser
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, int64, int64) (io.ReadCloser, error)); ok {
		return rf(repo, dig, size, start)
	}
	if rf, ok := ret.Get(0).(func(string, string, int64, int64) io.ReadCloser); ok {
		r0 = rf(repo, dig, size, start)
	} else {
		if ret.Get(0) != nil {
...
func (_m *RemoteInterface) ListReferrers(repo string, digest string, rawQuery string) (*v1.Index, map[string][]string, error) {
	ret := _m.Called(repo, digest, rawQuery)
	...
	if rf, ok := ret.Get(0).(func(string, string, string) (*v1.Index, map[string][]string, error)); ok {
		return rf(repo, digest, rawQuery)
	}
	if rf, ok := ret.Get(0).(func(string, string, string) *v1.Index); ok {
		r0 = rf(repo, digest, rawQuery)
	} else {
		if ret.Get(0) != nil {
