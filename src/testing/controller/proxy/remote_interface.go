...
// ListReferrers provides a mock function with given fields: repo, ref, rawQuery
func (_m *RemoteInterface) ListReferrers(repo string, ref string, rawQuery string) (*v1.Index, map[string][]string, error) {
	ret := _m.Called(repo, ref, rawQuery)
