...
func (_m *Controller) Start(ctx context.Context, policy *model.Policy, resource *model.Resource, trigger string, triggerRevision ...int64) (int64, error) {
	...
	var r0 int64
	if rf, ok := ret.Get(0).(func(context.Context, *model.Policy, *model.Resource, string, ...int64) int64); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *model.Policy, *model.Resource, string, ...int64) error); ok {
