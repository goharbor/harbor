...
import (
	...
	models "github.com/goharbor/harbor/src/pkg/role/model"
...
func (_m *Controller) Create(ctx context.Context, _a1 *models.Role) (int64, error) {
	...
	var r0 int64
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *models.Role) (int64, error)); ok {
		return rf(ctx, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *models.Role) int64); ok {
		r0 = rf(ctx, _a1)
	} else {
		r0 = ret.Get(0).(int64)
	}
...
func (_m *Controller) Get(ctx context.Context, projectIDOrName interface{}, options ...project.Option) (*models.Role, error) {
	...
	var r0 *models.Role
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, ...project.Option) (*models.Role, error)); ok {
		return rf(ctx, projectIDOrName, options...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, ...project.Option) *models.Role); ok {
...
func (_m *Controller) GetByName(ctx context.Context, projectName string, options ...project.Option) (*models.Role, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	...
	var r0 *models.Role
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, ...project.Option) (*models.Role, error)); ok {
		return rf(ctx, projectName, options...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, ...project.Option) *models.Role); ok {
...
func (_m *Controller) List(ctx context.Context, query *q.Query, options ...project.Option) ([]*models.Role, error) {
	_va := make([]interface{}, len(options))
	for _i := range options {
		_va[_i] = options[_i]
	}
	...
	var r0 []*models.Role
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *q.Query, ...project.Option) ([]*models.Role, error)); ok {
		return rf(ctx, query, options...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *q.Query, ...project.Option) []*models.Role); ok {
...
func (_m *Controller) Update(ctx context.Context, _a1 *models.Role) error {
	ret := _m.Called(ctx, _a1)
