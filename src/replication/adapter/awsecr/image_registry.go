...
var _ adp.ImageRegistry = awsecr{}

func (n awsecr) FetchImages(filters []*model.Filter) ([]*model.Resource, error) {
	nameFilterPattern := ""
	tagFilterPattern := ""
...
func (n awsecr) filterRepositories(pattern string) ([]string, error) {
...
func (n awsecr) filterTags(repository, pattern string) ([]string, error) {
