...
var (
	...
	ConfigList = []Item{
		...
		{Name: common.LDAPNestedGroup, Scope: UserScope, Group: LdapGroupGroup, EnvKey: "LDAP_NESTED_GROUP", DefaultValue: "false", ItemType: &BoolType{}, Editable: true, Description: `Enable nested group membership`},
