...
var (
	...
	ConfigList = []Item{
		...
		{Name: common.AdminInitialized, Scope: SystemScope, Group: BasicGroup, EnvKey: "", DefaultValue: "false", ItemType: &BoolType{}, Editable: false, Description: `Flag indicating whether the admin account has been initialized with a password`},
