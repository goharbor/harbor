...
var (
	...
	ConfigList = []Item{
		...
		{Name: common.CosignStrictVerificationEnabled, Scope: SystemScope, Group: BasicGroup, EnvKey: "COSIGN_STRICT_VERIFICATION_ENABLED", DefaultValue: "false", ItemType: &BoolType{}, Editable: false},
