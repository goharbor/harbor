...
func (suite *CacheTestSuite) SetupSuite() {
	suite.cache, _ = cache.New("redis://localhost:6379/0")
}
...
func TestRedis(t *testing.T) {
	c, err := cache.New("redis+sentinel://172.20.0.6:26379,172.20.0.5:26379,172.20.0.4:26379/redis-master?idle_timeout_seconds=30")
	fmt.Println(err)
	fmt.Println(c)
}
