...
import { NewOptimizerFormComponent } from './new-optimizer-form.component';
...
describe('NewOptimizerFormComponent', () => {
    let mockOptimizer1 = {
        name: 'test1',
    ...
    let component: NewOptimizerFormComponent;
    let fixture: ComponentFixture<NewOptimizerFormComponent>;
    let fakedConfigOptimizerService = {
        listOptimizers() {
            return of([mockOptimizer1]).pipe(delay(500));
        },
        getOptimizersByEndpointUrl() {
            return of([mockOptimizer1]).pipe(delay(500));
        },
    };
    beforeEach(() => {
        TestBed.configureTestingModule({
            ...
            declarations: [NewOptimizerFormComponent],
            providers: [
                UntypedFormBuilder,
                TranslateService,
                {
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(NewOptimizerFormComponent);
