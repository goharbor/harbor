...
import { of } from 'rxjs';
import { OptimizerMetadataComponent } from './optimizer-metadata.component';
import { ErrorHandler } from '../../../../../shared/units/error-handler';
import { OptimizerService } from '../../../../../../../ng-swagger-gen/services/optimizer.service';

describe('OptimizerMetadataComponent', () => {
    ...
    let component: OptimizerMetadataComponent;
    let fixture: ComponentFixture<OptimizerMetadataComponent>;
    let fakedConfigOptimizerService = {
        getOptimizerMetadata() {
            return of(mockOptimizerMetadata);
        },
    };
    beforeEach(() => {
        TestBed.configureTestingModule({
            ...
            declarations: [OptimizerMetadataComponent],
            providers: [
                ErrorHandler,
                {
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(OptimizerMetadataComponent);
