...
import { finalize, catchError, map, debounceTime, distinctUntilChanged, switchMap } from "rxjs/operators";
import { Subscription, forkJoin, timer, Observable, throwError as observableThrowError } from "rxjs";
import { TranslateService } from "@ngx-translate/core";
import { ListReplicationRuleComponent } from "./list-replication-rule/list-replication-rule.component";
import { CreateEditRuleComponent } from "./create-edit-rule/create-edit-rule.component";
import { ErrorHandler } from "../../../../shared/units/error-handler";
import { Comparator, ReplicationService } from "../../../../shared/services";
