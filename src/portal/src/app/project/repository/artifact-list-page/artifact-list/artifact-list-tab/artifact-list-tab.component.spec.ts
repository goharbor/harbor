...
import {
  IServiceConfig,
  SERVICE_CONFIG
} from '../../../../../../lib/entities/service.config';
...
describe('ArtifactListTabComponent (inline template)', () => {
  ...
  let mockArtifacts: Artifact[] = [
    {
      ...
      media_type: 'string',
      digest:
        'sha256:4875cda368906fd670c9629b5e416ab3d6c0292015f3c3f12ef37dc9a32fc8d4',
      size: 20372934,
      scan_overview: {
  ...
  beforeEach(() => {
    ...
    spyLabels = spyOn(labelService, 'getGLabels').and.returnValues(
      of(mockLabels).pipe(delay(0))
    );
    spyLabels1 = spyOn(labelService, 'getPLabels')
