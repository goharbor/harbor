...
type Controller interface {
	...
	Start(ctx context.Context, policy *model.Policy, resource *model.Resource, trigger string, triggerRevision ...int64) (executionID int64, err error)
...
func (c *controller) Start(ctx context.Context, policy *model.Policy, resource *model.Resource, trigger string, triggerRevision ...int64) (int64, error) {
