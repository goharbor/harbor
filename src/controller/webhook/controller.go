...
var (
	...
	// webhookJobVendors represents webhook(http), slack, or teams.
	webhookJobVendors = q.NewOrList([]any{job.WebhookJobVendorType, job.SlackJobVendorType, job.TeamsJobVendorType})
)
