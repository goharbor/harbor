...
class TestProjects(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        self.repo.delete_repository(TestProjects.project_push_index_name, self.index_name, **TestProjects.USER_CLIENT)
        self.repo.delete_repository(TestProjects.project_push_index_name, self.image_a, **TestProjects.USER_CLIENT)
        self.repo.delete_repository(TestProjects.project_push_index_name, self.image_b, **TestProjects.USER_CLIENT)
