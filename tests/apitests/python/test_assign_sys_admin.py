...
class TestProjects(unittest.TestCase):
    ...
    def testAssignSysAdmin(self):
        ...
        #2. Set user(UA) has sysadmin role by admin, check user(UA) can modify system configuration;
        self.user.update_uesr_role_as_sysadmin_success(TestProjects.user_assign_sys_admin_id, True, **ADMIN_CLIENT)
        ...
        self.user.update_uesr_role_as_sysadmin_success(TestProjects.user_assign_sys_admin_id, False, **ADMIN_CLIENT)
