...
class TestProjects(unittest.TestCase):
    ...
    def testDelRepo(self):
        ...
        self.artifact.waiting_for_reference_exist(self.project_name, repo_name, tag, **self.USER_CLIENT)

        repo_name_for_ctr = urllib.parse.quote(user_namespace + "/" + image_for_ctr,'utf-8')
        self.artifact.waiting_for_reference_exist(self.project_name, repo_name_for_ctr, tag_for_ctr, **self.USER_CLIENT)

        self.artifact.waiting_for_reference_exist(self.project_name, urllib.parse.quote(index_repo_name,'utf-8'), index_tag, **self.USER_CLIENT)
