...
Test Case - Replication Rule Edit
    ...
    Sign In Harbor    ${HARBOR_URL}    ${HARBOR_ADMIN}    ${HARBOR_PASSWORD}
    Switch To Registries
    Create A New Endpoint    harbor    ${endpoint1}    https://registry.goharbor.io    ${null}    ${null}    Y
...
Test Case - Replication Of Pull Manifest List and CNAB from Harbor To Self
    ...
    Body Of Replication Of Pull Images from Registry To Self   harbor  https://registry.goharbor.io  ${null}  ${null}  nightly/{${image1},${image2},${image3}}  ${null}  Y  Flatten 1 Level  @{target_images}
