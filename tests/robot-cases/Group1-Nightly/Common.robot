...
Test Case - User View Logs
    ...
    Body Of Replication Of Pull Images from Registry To Self   harbor  https://registry.goharbor.io  ${null}  ${null}  nightly/${replication_image}  project${d}  N  Flatten 1 Level  @{target_images}
...
Test Case - Job Service Dashboard Workers
    ...
    Create A New Endpoint  harbor  ${endpoint_name}  https://registry.goharbor.io  ${null}  ${null}
