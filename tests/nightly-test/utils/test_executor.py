...
def execute_test_ova(harbor_endpoint, harbor_root_pwd, test_suite, harbor_pwd='Harbor12345') :
    ...
    if test_suite == 'Nightly':
        cmd = cmd + "/drone/tests/robot-cases/robot-cases/Group11-Nightly/Nightly.robot"

    if test_suite == 'Longevity':
        cmd = cmd + "/drone/tests/robot-cases/robot-cases/Group10-Longevity/Longevity.robot"
