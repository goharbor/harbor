Test 3-02 - Manage Project Publicity
=======

# Purpose:

To verify that a non system admin user can change project publicity of a project using local database authentication.
