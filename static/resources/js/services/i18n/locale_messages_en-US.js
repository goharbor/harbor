...
var locale_messages = {
  ...
  'why_use_Cargo': 'Why use Cargo?',
  'index_desc': 'Project Cargo is an enterprise-class registry server, which extends the open source Docker Registry server by adding the functionality usually required by an enterprise, such as security, control, and management. Cargo is primarily designed to be a private registry - providing the needed security and control that enterprises require. It also helps minimize bandwidth usage, which is helpful to both improve productivity as well as performance.',
  ...
  'count': 'Downloads',
  'creator': 'Creator',
  'no_top_repositories': 'No data, start with Cargo now!',
  'logs': 'Logs',
  'task_name': 'Task Name',
  'details': 'Details',
  'user': 'User',
