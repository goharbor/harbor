...
var locale_messages = {
  ...
  'tag_name_is_required': '标记名称为必填项',
  'custom_name_is_required': '客户名称为必填项',
  'label_name_is_required': '源数据为必填项。',
  'project_already_exist': '项目已存在。',
  'tag_already_exist': '标记名已存在。',
  'custom_already_exist': '客户已存在。',
  'label_already_exist': '源数据已存在。',
  'tag_name_is_invalid': '中文名称无效。',
  'project_name_is_invalid': '项目名称无效。全部为小写字母，且不能包含空格。',
  'custom_name_is_invalid': '客户名称无效。全部为小写字母，且不能包含空格。',
